...
@lru_cache
def get_prospecto_twenty() -> TwentyProspectoClient:
    """Cliente del objeto `prospecto` en Twenty (camino Twenty del dialer)."""
    s = get_settings()
    return TwentyProspectoClient(base_url=s.twenty_base_url, api_key=s.twenty_api_key)
